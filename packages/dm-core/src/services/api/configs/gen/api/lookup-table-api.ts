...
export const LookupTableApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createLookup(application: string, recipePackage: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const operationBasePath = operationServerMap['LookupTableApi.createLookup']?.[index]?.url;
        ...
        async getLookup(application: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['LookupTableApi.getLookup']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
        /**
         * Recreate an existing Recipe Lookup Table for an Application. For example, after updating the recipe links.  Args: - application (str): The name of the application to recreate. - user (User): The authenticated user accessing the endpoint, automatically generated from provided bearer token or Access-Key.  Returns: - void
        ...
        async refreshLookup(application: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Lookup>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['LookupTableApi.refreshLookup']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export const LookupTableApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getLookup(requestParameters: LookupTableApiGetLookupRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.getLookup(requestParameters.application, options).then((request) => request(axios, basePath));
        },
        /**
         * Recreate an existing Recipe Lookup Table for an Application. For example, after updating the recipe links.  Args: - application (str): The name of the application to recreate. - user (User): The authenticated user accessing the endpoint, automatically generated from provided bearer token or Access-Key.  Returns: - void
         * @summary Refresh Lookup
         * @param {LookupTableApiRefreshLookupRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        refreshLookup(requestParameters: LookupTableApiRefreshLookupRequest, options?: AxiosRequestConfig): AxiosPromise<Lookup> {
...
/**
 * Request parameters for refreshLookup operation in LookupTableApi.
 * @export
 * @interface LookupTableApiRefreshLookupRequest
 */
export interface LookupTableApiRefreshLookupRequest {
    /**
     * 
     * @type {string}
     * @memberof LookupTableApiRefreshLookup
     */
    readonly application: string
}
...
export class LookupTableApi extends BaseAPI {
     ...
     * @memberof LookupTableApi
     */
    public refreshLookup(requestParameters: LookupTableApiRefreshLookupRequest, options?: AxiosRequestConfig) {
        return LookupTableApiFp(this.configuration).refreshLookup(requestParameters.application, options).then((request) => request(this.axios, this.basePath));
    }
}
