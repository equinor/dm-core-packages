...
export const AttributeApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async attributeGet(address: string, resolve?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetAttributeResponse>> {
            ...
            const operationBasePath = operationServerMap['AttributeApi.attributeGet']?.[index]?.url;
...
export const AttributeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        attributeGet(requestParameters: AttributeApiAttributeGetRequest, options?: AxiosRequestConfig): AxiosPromise<GetAttributeResponse> {
