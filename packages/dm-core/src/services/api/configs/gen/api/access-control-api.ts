...
export const AccessControlApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getAcl(address: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccessControlList>> {
            ...
            const operationBasePath = operationServerMap['AccessControlApi.getAcl']?.[index]?.url;
        ...
        async setAcl(address: string, accessControlList: AccessControlList, recursively?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
            ...
            const index = configuration?.serverIndex ?? 0;
            const operationBasePath = operationServerMap['AccessControlApi.setAcl']?.[index]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
        },
    }
};
...
export class AccessControlApi extends BaseAPI {
    ...
    public getAcl(requestParameters: AccessControlApiGetAclRequest, options?: AxiosRequestConfig) {
        return AccessControlApiFp(this.configuration).getAcl(requestParameters.address, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public setAcl(requestParameters: AccessControlApiSetAclRequest, options?: AxiosRequestConfig) {
        return AccessControlApiFp(this.configuration).setAcl(requestParameters.address, requestParameters.accessControlList, requestParameters.recursively, options).then((request) => request(this.axios, this.basePath));
    }
}
