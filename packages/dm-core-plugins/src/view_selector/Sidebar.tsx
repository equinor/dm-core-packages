...
export const Sidebar = (props: {
	...
	const { selectedViewId, setSelectedViewId, viewSelectorItems, addView } = props
											...
											<SideBar.AccordionItem
												...
												icon={
													subConfig.viewConfig.eds_icon
														? EdsIcons[subConfig.viewConfig.eds_icon as keyof typeof EdsIcons]
														: EdsIcons.subdirectory_arrow_right
												}
												label={subConfig.label}
												role='tab'
												onClick={() => {
													addView(subViewId, subConfig.viewConfig, undefined, true)
