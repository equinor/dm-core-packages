							...
							<li key={index}>
								<div style={{ display: 'flex', alignItems: 'center' }}>
									...
									<Button
										...
										onClick={() =>
											setExtends(
												formData.filter((typeToRemove: string) => typeToRemove !== typeRef)
											)
										}
									>
			...
			<div style={{ display: 'flex', alignItems: 'self-end' }}>
				<div style={{ display: 'block' }}>
					...
					>
						...
						<option key={attribute.attributeType}>{attribute.attributeType}</option>
					</Select>
				</div>
					...
					formData.attributes.map((attribute: any, index: number) => (
						<Accordion.Item key={index}>
							<Accordion.Header>
								...
								{attribute?.contained === undefined || attribute?.contained === true
									? 'Contained'
									: 'Uncontained'}
								<Button
									variant='ghost_icon'
