						...
						>
							<Stack direction='row' spacing={0.5} alignItems='center'>
								...
								>
									...
									>
										<Icon
											data={internalConfig.openAsTab ? external_link : chevron_right}
								...
								{internalConfig.headers.map((attribute: string, index: number) => {
								...
								{internalConfig.functionality.sort && (
									<>
										...
										<ListItemButton
											type='down'
											disabled={
												index === paginationRowsPerPage - 1 || index === items?.length - 1
											}
											onClick={() => {
												moveItem(item, 'down')
											}}
